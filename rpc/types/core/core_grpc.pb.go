...
func (c *coreClient) DeleteToken(ctx context.Context, in *IDsReq, opts ...grpc.CallOption) (*BaseResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BaseResp)
...
func (c *coreClient) GetTokenById(ctx context.Context, in *IDReq, opts ...grpc.CallOption) (*TokenInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TokenInfo)
...
func (c *coreClient) BlockUserAllToken(ctx context.Context, in *IDReq, opts ...grpc.CallOption) (*BaseResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BaseResp)
...
func (c *coreClient) CreateUser(ctx context.Context, in *UserInfo, opts ...grpc.CallOption) (*BaseIDResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BaseIDResp)
...
func (c *coreClient) DeleteUser(ctx context.Context, in *IDsReq, opts ...grpc.CallOption) (*BaseResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BaseResp)
...
type CoreServer interface {
	...
	// group: token
	DeleteToken(context.Context, *IDsReq) (*BaseResp, error)
	// group: token
	GetTokenList(context.Context, *TokenListReq) (*TokenListResp, error)
	// group: token
	GetTokenById(context.Context, *IDReq) (*TokenInfo, error)
	// group: token
	BlockUserAllToken(context.Context, *IDReq) (*BaseResp, error)
	// group: token
...
func (UnimplementedCoreServer) DeleteToken(context.Context, *IDsReq) (*BaseResp, error) {
...
func (UnimplementedCoreServer) GetTokenById(context.Context, *IDReq) (*TokenInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTokenById not implemented")
}
func (UnimplementedCoreServer) BlockUserAllToken(context.Context, *IDReq) (*BaseResp, error) {
...
func (UnimplementedCoreServer) CreateUser(context.Context, *UserInfo) (*BaseIDResp, error) {
...
func _Core_DeleteToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoreServer).DeleteToken(ctx, req.(*IDsReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Core_GetTokenById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoreServer).GetTokenById(ctx, req.(*IDReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Core_BlockUserAllToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoreServer).BlockUserAllToken(ctx, req.(*IDReq))
	}
	return interceptor(ctx, in, info, handler)
}
