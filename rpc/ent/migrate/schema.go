...
var (
	...
	SysTenantsColumns = []*schema.Column{
		...
		{Name: "contact_email", Type: field.TypeString, Nullable: true, Comment: "联系邮箱"},
		{Name: "company_name", Type: field.TypeString, Nullable: true, Comment: "企业名称"},
		{Name: "license_number", Type: field.TypeString, Nullable: true, Comment: "统一社会信用代码"},
		{Name: "address", Type: field.TypeString, Nullable: true, Comment: "地址"},
		{Name: "intro", Type: field.TypeString, Nullable: true, Comment: "企业简介"},
		{Name: "domain", Type: field.TypeString, Nullable: true, Comment: "域名"},
		{Name: "level", Type: field.TypeUint32, Comment: "租户级别"},
		{Name: "plan_id", Type: field.TypeInt64, Nullable: true, Comment: "套餐计划Id，外键关联 tenant_plan.id"},
		{Name: "admin_id", Type: field.TypeInt64, Nullable: true, Comment: "管理员id"},
		{Name: "parent_id", Type: field.TypeInt64, Nullable: true, Comment: "父级id,0为第一级"},
	}
