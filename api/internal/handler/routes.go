...
import (
	...
	api "github.com/saas-mingyang/mingyang-admin-core/api/internal/handler/api"
	authority "github.com/saas-mingyang/mingyang-admin-core/api/internal/handler/authority"
	base "github.com/saas-mingyang/mingyang-admin-core/api/internal/handler/base"
	captcha "github.com/saas-mingyang/mingyang-admin-core/api/internal/handler/captcha"
	configuration "github.com/saas-mingyang/mingyang-admin-core/api/internal/handler/configuration"
	department "github.com/saas-mingyang/mingyang-admin-core/api/internal/handler/department"
	dictionary "github.com/saas-mingyang/mingyang-admin-core/api/internal/handler/dictionary"
	dictionarydetail "github.com/saas-mingyang/mingyang-admin-core/api/internal/handler/dictionarydetail"
	emaillog "github.com/saas-mingyang/mingyang-admin-core/api/internal/handler/emaillog"
	emailprovider "github.com/saas-mingyang/mingyang-admin-core/api/internal/handler/emailprovider"
	menu "github.com/saas-mingyang/mingyang-admin-core/api/internal/handler/menu"
	messagesender "github.com/saas-mingyang/mingyang-admin-core/api/internal/handler/messagesender"
	oauthprovider "github.com/saas-mingyang/mingyang-admin-core/api/internal/handler/oauthprovider"
	position "github.com/saas-mingyang/mingyang-admin-core/api/internal/handler/position"
	publicapi "github.com/saas-mingyang/mingyang-admin-core/api/internal/handler/publicapi"
	publicuser "github.com/saas-mingyang/mingyang-admin-core/api/internal/handler/publicuser"
	role "github.com/saas-mingyang/mingyang-admin-core/api/internal/handler/role"
	smslog "github.com/saas-mingyang/mingyang-admin-core/api/internal/handler/smslog"
	smsprovider "github.com/saas-mingyang/mingyang-admin-core/api/internal/handler/smsprovider"
	task "github.com/saas-mingyang/mingyang-admin-core/api/internal/handler/task"
	tasklog "github.com/saas-mingyang/mingyang-admin-core/api/internal/handler/tasklog"
	tenant "github.com/saas-mingyang/mingyang-admin-core/api/internal/handler/tenant"
	tenantplan "github.com/saas-mingyang/mingyang-admin-core/api/internal/handler/tenantplan"
	token "github.com/saas-mingyang/mingyang-admin-core/api/internal/handler/token"
	user "github.com/saas-mingyang/mingyang-admin-core/api/internal/handler/user"
	...
	server.AddRoutes(
		rest.WithMiddlewares(
			...
			[]rest.Route{
				{
					Method:  http.MethodPost,
					Path:    "/tenant_plan/create",
					Handler: tenantplan.CreateTenantPlanHandler(serverCtx),
				},
				{
					Method:  http.MethodPost,
					Path:    "/tenant_plan/update",
					Handler: tenantplan.UpdateTenantPlanHandler(serverCtx),
				},
				{
					Method:  http.MethodPost,
					Path:    "/tenant_plan/delete",
					Handler: tenantplan.DeleteTenantPlanHandler(serverCtx),
				},
				{
					Method:  http.MethodPost,
					Path:    "/tenant_plan/list",
					Handler: tenantplan.GetTenantPlanListHandler(serverCtx),
				},
				{
					Method:  http.MethodPost,
					Path:    "/tenant_plan",
					Handler: tenantplan.GetTenantPlanByIdHandler(serverCtx),
				},
			}...,
		),
		rest.WithJwt(serverCtx.Config.Auth.AccessSecret),
