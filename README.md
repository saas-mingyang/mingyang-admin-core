...
| 模块名称       | 模块介绍 | 模块地址                                                                      |
|------------|------|---------------------------------------------------------------------------|
| Core       | 核心模块 | [Core](https://github.com/saas-mingyang/mingyang-admin-core)                     |
...
| Job        | 定时任务 | [Job](https://github.com/saas-mingyang/mingyang-admin-job)                       |
| MMS        | 会员管理 | [Member](https://github.com/suyuan32/simple-admin-member-api)             |
| MCMS       | 消息中心 | [Message Center](https://github.com/saas-mingyang/mingyang-admin-message-center) |
...
非常欢迎你的加入！[提一个 Issue](https://github.com/saas-mingyang/mingyang-admin-core/issues/new) 或者提交一个 Pull Request。
...
> [论坛](https://github.com/saas-mingyang/mingyang-admin-core/discussions)
