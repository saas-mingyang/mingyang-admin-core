...
[![Release](https://img.shields.io/badge/Release-v1.7.4-green.svg)](https://github.com/saas-mingyang/mingyang-admin-core/releases)
...
|-------------|---------------------|---------------------------------------------------------------------------|
| Core        | Core Module         | [Core](https://github.com/saas-mingyang/mingyang-admin-core)                     |
...
| Job         | Scheduled Task      | [Job](https://github.com/saas-mingyang/mingyang-admin-job)                       |
| MMS         | Member Management   | [Member](https://github.com/suyuan32/simple-admin-member-api)             |
| MCMS        | Message Center      | [Message Center](https://github.com/saas-mingyang/mingyang-admin-message-center) |
...
[RoadMap](https://github.com/saas-mingyang/mingyang-admin-core/issues/63)
...
You are very welcome to join！[Raise an issue](https://github.com/saas-mingyang/mingyang-admin-core/issues/new) Or submit a Pull Request。
...
> [Discussion](https://github.com/saas-mingyang/mingyang-admin-core/discussions)

## Stars

[![Star History Chart](https://api.star-history.com/svg?repos=suyuan32/simple-admin-core&type=Date)](https://github.com/saas-mingyang/mingyang-admin-core)
